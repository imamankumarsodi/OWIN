...
class NewFilterVCAman:BaseViewController  {
    ...
    */
    ...
    @IBAction func btnTasteTapped(_ sender: UIButton) {
        ...
        btnTasteRef.setImage(#imageLiteral(resourceName: "f_checked"), for: .normal)
    ...
    @IBAction func btnTypeTapped(_ sender: UIButton) {
        btnTypeRef.setImage(#imageLiteral(resourceName: "f_checked"), for: .normal)
        if sender.tag == 0{
    ...
    @IBAction func btnEatTypeTapped(_ sender: UIButton) {
        ...
        btnEatTypeRef.setImage(#imageLiteral(resourceName: "f_checked"), for: .normal)
